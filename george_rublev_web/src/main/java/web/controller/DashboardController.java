...
public class DashboardController {
    ...
    @ResponseBody
    public String indexTaxi(@RequestParam("login") String login,@RequestParam("pass") String password){
        log.info("controller");
    ...
    public String great(@RequestParam("login") String name,@RequestParam("pass") String paswd, Model model, HttpSession session) {
