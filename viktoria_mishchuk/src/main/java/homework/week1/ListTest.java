...
//        Get from front, mid, end
        milis = System.currentTimeMillis();
        arrayList.get(0);
        System.out.println("get front arraylist = " + (System.currentTimeMillis() - milis) + " ms");

        milis = System.currentTimeMillis();
        linkedList.get(0);
        System.out.println("get front linkedlist = " + (System.currentTimeMillis() - milis) + " ms");
        ...
        milis = System.currentTimeMillis();
        arrayList.get(n - 4);
        System.out.println("get last arraylist = " + (System.currentTimeMillis() - milis) + " ms");

        milis = System.currentTimeMillis();
        linkedList.get(n - 4);
        System.out.println("get last linkedlist = " + (System.currentTimeMillis() - milis) + " ms");
...
//        Delete from front, mid, end.
        ...
        System.out.println("del mid arraylist = " + (System.currentTimeMillis() - milis) + " ms");

        milis = System.currentTimeMillis();
        linkedList.remove(n / 2);
        System.out.println("del mid linkedlist = " + (System.currentTimeMillis() - milis) + " ms");

        milis = System.currentTimeMillis();
        arrayList.remove(n - 4);
        System.out.println("del end arraylist = " + (System.currentTimeMillis() - milis) + " ms");

        milis = System.currentTimeMillis();
        linkedList.remove(n - 4);
        System.out.println("del end linkedlist = " + (System.currentTimeMillis() - milis) + " ms");
