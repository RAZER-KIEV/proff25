...
//Создать класс пользователь с полями логин, пароль, время истечения действия пароля
//Реализовать метод, которому передается логин и пароль пользователя. Метод определяет, авторизирован пользователь или нет
//(есть ли в списке пользователей). Сверяет по хешкоду и equals.

//Создать 5 пользователей, упорядочить их по возрастанию кол-ва дней до истечения строка действия паролей
